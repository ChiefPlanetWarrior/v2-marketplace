...
/* harmony import */ var _components_Container_Container__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(5676);
...
/* harmony import */ var _const_contractAddresses__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(3487);
/* harmony import */ var _styles_Token_module_css__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(582);
...
/* harmony import */ var _util_randomColor__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(7162);
/* harmony import */ var _components_Skeleton_Skeleton__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(1231);
/* harmony import */ var react_hot_toast__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(6201);
/* harmony import */ var _util_toastConfig__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(4655);
...
function TokenPage({ nft , contractMetadata  }) {
    ...
    const { contract: nftCollection  } = (0,_thirdweb_dev_react__WEBPACK_IMPORTED_MODULE_1__.useContract)(_const_contractAddresses__WEBPACK_IMPORTED_MODULE_5__/* .NFT_COLLECTION_ADDRESS */ .f2);
    const { data: directListing , isLoading: loadingDirect  } = (0,_thirdweb_dev_react__WEBPACK_IMPORTED_MODULE_1__.useValidDirectListings)(marketplace, {
        tokenContract: _const_contractAddresses__WEBPACK_IMPORTED_MODULE_5__/* .NFT_COLLECTION_ADDRESS */ .f2,
    ...
    async function createBidOrOffer() {
        ...
        if (auctionListing?.[0]) {
            ...
            txResult = await marketplace?.offers.makeOffer({
                assetContractAddress: _const_contractAddresses__WEBPACK_IMPORTED_MODULE_5__/* .NFT_COLLECTION_ADDRESS */ .f2,
                tokenId: nft.metadata.id,
                totalPrice: bidValue
            });
        } else {
                                ...
                                loadingContract || loadingDirect || loadingAuction ? /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_components_Skeleton_Skeleton__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .Z, {
                                    ...
                                    children: [
                                        /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_thirdweb_dev_react__WEBPACK_IMPORTED_MODULE_1__.Web3Button, {
                                            ...
                                            className: (_styles_Token_module_css__WEBPACK_IMPORTED_MODULE_11___default().btn),
                                            onSuccess: ()=>{
...
const getStaticProps = async (context)=>{
    ...
    const sdk = new _thirdweb_dev_sdk__WEBPACK_IMPORTED_MODULE_4__.ThirdwebSDK(_const_contractAddresses__WEBPACK_IMPORTED_MODULE_5__/* .NETWORK */ .IB);
    const contract = await sdk.getContract(_const_contractAddresses__WEBPACK_IMPORTED_MODULE_5__/* .NFT_COLLECTION_ADDRESS */ .f2);
...
const getStaticPaths = async ()=>{
    ...
    const paths = nfts.map((nft)=>{
        return {
            params: {
                contractAddress: _const_contractAddresses__WEBPACK_IMPORTED_MODULE_5__/* .NFT_COLLECTION_ADDRESS */ .f2,
                tokenId: nft.metadata.id
            }
        };
    });
...
var __webpack_exports__ = __webpack_require__.X(0, [664,487,697,437], () => (__webpack_exec__(8988)));
